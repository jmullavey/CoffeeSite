        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="h-64 rounded-xl overflow-hidden shadow-xl">
              <img
                src="https://mobile-cuisine.com/wp-content/uploads/2021/12/IMG_0328-600x450.jpg"
                alt="Mobile Coffee Cart - Sarah's first cart downtown"
                className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-300"
              />
              <div className="text-center text-sm mt-2 text-gray-500">Sarah's first mobile coffee cart in Portland</div>
            </div>
            <div className="h-64 rounded-xl overflow-hidden shadow-xl">
              <img
                src="https://plus.unsplash.com/premium_photo-1682148052960-4285839caefe?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Coffee Roasting Process - beans being roasted"
                className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-300"
              />
              <div className="text-center text-sm mt-2 text-gray-500">Fresh beans roasting in our micro-roastery</div>
            </div>
            <div className="h-64 rounded-xl overflow-hidden shadow-xl col-span-2">
              <img
                src="https://www.addtoevent.co.uk/sites/default/files/styles/x_large/gs.ate-mp-production-0a18-drupal-public-files/drupal/user/748824/supplier/images/491ee77e-ba9f-46bf-bbbb-451f1cba007d.jpg"
                alt="Coffee Shop Interior - welcoming space"
                className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-300"
              />
              <div className="text-center text-sm mt-2 text-gray-500">Our welcoming shop interior, designed for community</div>
            </div>
          </div>
        </div>
      </div>
