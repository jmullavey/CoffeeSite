      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 flex flex-col items-center">
          <div className="w-full max-w-md">
            ...
            >
              <button
                className={`flex-1 flex items-center justify-center py-2.5 px-4 text-sm font-semibold rounded-full transition-all duration-300 focus:outline-none focus:z-10 group ${state.orderType === 'delivery'
              ...
              <button
                className={`flex-1 flex items-center justify-center py-2.5 px-4 text-sm font-semibold rounded-full transition-all duration-300 focus:outline-none focus:z-10 group ${state.orderType === 'pickup'
                  ? 'bg-primary text-white shadow-md'
                  : 'bg-transparent text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700'}`}
